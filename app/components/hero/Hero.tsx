...
export default function Hero(){
    return (
        <div>
             <div className="w-full md:px-16 px-4 pb-14 pt-8 md:py-14 bg-darky-700">
            <div className="md:flex-row flex items-center justify-between flex-col w-full">
                <div className="w-full md:w-1/2 md:p-5 p-2">
                    <Image src='/images/hero-truck.png' alt='Camion de signaleur routier' className='px-6' width="900" height="900" />
                </div>
                <div className="w-full md:w-1/2 flex flex-col items-start justify-center md:px-5 px-2">
                    <h1 className="md:text-xl text-lg font-bold text-darky-100 pb-1.5"> La sécurité de vos chantiers entre de bonnes mains </h1>
