...
export default function Services(){
    ...
    return (
       ...
       {/** why us */}
                <div className="w-full bg-darky-50 py-10 md:px-24 px-6">
                    ...
                    <div className="w-full flex flex-col items-center justify-center md:justify-around py-4 md:py-8 mx-auto text-center">
                        ...
                        <h2 className="text-xl text-darky-700 font-semibold pb-4 md:pb-8"> Votre sécurité est notre priorité absolue </h2>
                        <span className="w-12 h-1 bg-primary-200 rounded-lg "></span>
                    </div>
...
{/** where*/}
                <div className="bg-primary-300">
                    <div className="container w-full mx-auto py-8 md:px-24">
                <div className="w-full flex flex-col items-center justify-center md:justify-around py-4 md:py-8 mx-auto text-center">
