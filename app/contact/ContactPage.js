...
export default function Contact() {
  ...
  return (
    <>
      <div className="w-full py-10 md:py-10 px-0 md:px-20">
            ...
            <form onSubmit={handleSubmit} className="py-2 w-full px-4">
              ...
              <div className="w-full flex flex-row justify-between items-between">
                ...
                <div className="w-full flex flex-col items-start justify-around pt-2 pb-3 pl-2">
                  ...
                  <input value={phone} onChange={(e) => setPhone(e.target.value)} type="number" name="phone" placeholder="+1-438-526-5465" id="phone"
                    className="w-full py-3 px-2 text-darky-600 placeholder-darky-600  font-medium bg-darky-200 rounded-md border-2 border-transparent focus:border-2 focus:border-primary-300 outline-none transition-all ease-in-out" />
                </div>
              </div>
              <div className="w-full flex flex-row justify-between items-start">
                <div className="w-full flex flex-col items-start justify-around pt-2 pb-3 pr-2">
                  ...
                  <input value={company} onChange={(e) => setCompany(e.target.value)} type="text" name="company" placeholder="Entrer le nom de l'entreprise" id="company"
                    className="w-full py-3 px-2 text-darky-600 placeholder-darky-600  font-medium bg-darky-200 rounded-md border-2 border-transparent focus:border-2 focus:border-primary-300 outline-none transition-all ease-in-out"
                  />
                </div>
                <div className="w-full flex flex-col items-start justify-around  pt-2 pb-3 pl-2">
              ...
              <div className="flex flex-col items-start justify-around pt-2 pb-3">
                ...
                <textarea value={message} onChange={(e) => setMessage(e.target.value)} name="message" id="message" placeholder="Entrez les détails"
                  className="w-full pt-2 pb-12 px-2 text-darky-600 placeholder-darky-600  font-medium bg-darky-200 rounded-md border-2 border-transparent focus:border-2 focus:border-primary-300 outline-none transition-all ease-in-out"
                ></textarea>
              </div>
              <div className="flex flex-col items-start justify-around pt-2 pb-3">
                ...
                <button
                  type="submit"
                  className="self-end mt-3 py-3 px-8 text-primary-700 text-base font-semibold rounded-md shadow-md bg-primary-400 inline-flex items-center justify-around font-semibold hover:bg-primary-500">
