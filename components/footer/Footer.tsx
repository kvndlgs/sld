          ...
          >
            ...
            <div className="mt-4 space-y-4 lg:mt-0">
              ...
              <form className="mt-4 w-full">
                <label htmlFor="email" className="sr-only"> Obtenir une soumission </label>
                <div className="flex-col pb-2">
                  <label htmlFor="nom" className="text-white pb-2">Nom</label>
                  <input
                    type="text"
                    id="nom"
                    placeholder="Nom"
                ...
                <div
                  className="flex-col pb-2" >
                  <label htmlFor="phone" className="text-white pb-32">Numero de telephone</label>
                  <input
                    type="phone"
                    id="phone"
          ...
          <div className="py-6 lg:py-16 lg:pe-16">
            ...
            <div className="mt-8 border-t border-darky-500 pt-8">
              <ul className="flex flex-wrap gap-4 text-sm">
                <li>
                  <a href="#" className="text-darky-700 transition hover:opacity-75">
                    Termes & Conditions
                  </a>
                </li>
